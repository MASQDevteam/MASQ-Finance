page 71102 "MASQ Budget Matrix"
{
        ...
        area(content)
        {
            repeater(Group)
            {
                ...
                field("Posted Entries Amount"; Rec."Posted Entries Amount")
                {
                    ...
                    var
                        MASQBudgetControl: Codeunit "Budget Control";
                    begin
                        MASQBudgetControl.LookupPostedEntries(Rec);
                    end;
                }
    ...
    ; Dim2: Code[20]; Dim3: Code[20]; Dim4: Code[20]; Dim5: Code[20]; Dim6: Code[20]; Dim7: Code[20]; Dim8: Code[20]; AccTypeFilter: Enum "MASQ G/L Account Type")
    var
    begin
