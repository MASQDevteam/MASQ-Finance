table 71100 "Budget Entry"
{
    ...
    DrillDownPageID = "MASQ Budget Matrix";
    LookupPageID = "MASQ Budget Matrix";
    ...
    fields
    {
        ...
        field(22; "G/L Account Type"; Enum "MASQ G/L Account Type")
        {
    ...
    var
        GLBudgetName: Record "MASQ Budget";
